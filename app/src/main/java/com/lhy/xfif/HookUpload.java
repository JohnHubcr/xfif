...
//                            XposedBridge.log("AfterHook!" + classLoader.toString());
                            ...
                            XposedHelpers.findAndHookMethod("com.fifedu.tsdx.ui.activity.report.challengereport.Report",
                                    classLoader, "uploadAnsByCode", String.class, new XC_MethodHook() {
                                        @Override
                                        protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
//                                            XposedBridge.log("uploadAnsByCode before");
                                            XSharedPreferences xSharedPreferences = new XSharedPreferences("com.lhy.xfif", "xfif");
//                                            XposedBridge.log(xSharedPreferences.getBoolean("isOpen", false) + "");

                                            if (xSharedPreferences.getBoolean("isOpen", false)) {
                                                ...
                                                for (int i = 0; i < list.size(); i++) {
                                                     ...
                                                     * 修改分数
                                                     */
                                                    scoreField.set(list.get(i), xSharedPreferences.getInt("score", 80));
                                                }
